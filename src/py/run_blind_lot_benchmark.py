...
def parse_args() -> argparse.Namespace:
    ...
    if args.provider == "openai" and args.model == "mock-order-only-v1":
        parser.error("--provider openai requires an explicit --model")
    return args
...
def main() -> None:
    ...
    folds = tuple(range(5)) if args.all_folds else (args.fold,)
